<template>
    <div class="container">
        ...
        <div ref="arrowOne" class="arrow-container">
            <router-link to="/externalbathroom/">
...
export default {
    ...
    mounted(){
        ...
        this.marzObj = createMarzipano(elem, '/assets/scenes/Exterior.jpg')
    ...
    data(){
        return {
            ...
            coords: {
                arrowOne: {yaw: -0.6528655299637341, pitch: -0.0051562669296624},
                arrowTwo: {yaw: -0.3528655299637341, pitch: -0.0051562669296624},
                arrowThree: {yaw: -0.1528655299637341, pitch: -0.0051562669296624},
                arrowFour: {yaw: -0.2528655299637341, pitch: -0.0051562669296624},
            }
        }
    },
    methods: {
